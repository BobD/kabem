...
kaBEM also gives you the use of BEM classnames with mutliple modifiers, for example: <pre>__block__elemend__modifier1_modifier2</pre>
...
##Getting Started
  ...
  6. Add your HTML and fill the scaffolded BEM CSS (inside src/css/kabem/bem) with more CSS goodness and let me know how it works.
