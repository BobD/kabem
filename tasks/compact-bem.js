...
module.exports = function(grunt) {
	 ...
	 grunt.registerTask('compact-bem', 'Makes the use of multiple modifiers in a bem classname possible: "block__element_modifier1_modifier_2"', function() {
    	...
    	grunt.file.write(grunt.option('kabem-path') + '/bem_compact.scss', cssString);
	 });
}